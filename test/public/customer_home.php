...
<body>
<?php
echo "<h2 id=cust> Welcome $customer_name  </h2>";
...
?>
<p class="notification">Here you can check our various categories and see the several dishes we offer. If you look through and you find any dish you are dying to try (or eat) our order button does the whole trick.
</p>
<div class="listing">
<?php
