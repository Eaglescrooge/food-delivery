...
extract($result)
    ...
    <div class="one-third <?php echo strtolower($cat_name); ?>">
      ...
      <p class="notification"><a href="<?php echo "".$cat_id ?>"><?php echo $cat_name ?></a><br>
      <span class="des"><?php echo $description; ?></span><br>
      <a href="food_unregister.php?cat_id=<?php echo $cat_id ?>&cat_name=<?php echo $cat_name ?>"><button id="bt">VIEW ALL <?php echo strtoupper($cat_name); ?></button></a></p>
    </div>
